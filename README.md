...
|:---|:---|:---|:---|:---|
|Bldg Type_Duplex|Categorical|Type of dwelling|Negative|-4109.03|
...
|BsmtFin Type 2_LwQ|Categorical|Quality of second finished area (Low)|Negative|-8778.94|
|BsmtFin Type 2_Rec|Categorical|Quality of second finished area (Average Rec Room)|Negative|-8744.48|
...
|Exterior 2nd_HdBoard|Categorical|Exterior covering on house (Hard Board)|Negative|-4833.01|
...
|Neighborhood_NWAmes|Categorical|Physical locations within Ames city limits (Northwest Ames)|Negative|-7504.97|
...
|Overall Cond|Rating|Overall condition rating|Positive|3258.23|
...
|Roof Style_Hip|Categorical|Type of roof (Hip)|Positive|8173.70|
